...
const Vote2025 = () => {
	...
	const handleInputChange = (event) => {
  	...
  	const handleSubmit = async () => {
		...
		try {
			await setDoc(doc(firebaseFirestore, 'surveys/2025/responses', user.uid), {
	...
	return (
		<div class="main-content">
			<h2>{profileData.username}'s 2025 Cookie Rankings</h2>
			<p>
			...
			<div>
				<div>
					...
					<select name="newFirstChoice"
						...
						<option value="chocPepClusters">White Chocolate Peppermint Clusters</option>
